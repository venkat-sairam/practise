...
;
    ...
    SELECT 
        ...
        f.NAME, COUNT(*) as eligible_count
        FROM FAMILIES f
        INNER JOIN COUNTRIES c 
        on f.FAMILY_SIZE >= c.MIN_SIZE AND f.FAMILY_SIZE <= MAX_SIZE
        group BY f.NAME
